<x-app-layout>
  ...
  <div class="mx-auto max-w-2xl text-center">
    <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">登録画面</h2>
  </div>
  ...
  <form action="/confirm" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
    ...
    <div class="grid grid-cols-1 gap-y-6 gap-x-8 sm:grid-cols-2">
      ...
      <div class="sm:col-span-2">
        ...
        <div class="mt-2.5">
          <input type='file' name="jpb_history_sheet" rows="4" class="block w-full rounded-md border-0 py-2 px-3.5 text-sm leading-6 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600"></input>
        </div>
      </div>
     
    <div class="justify-center mt-4 px-20">
